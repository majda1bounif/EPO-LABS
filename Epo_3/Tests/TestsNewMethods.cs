...
namespace Tests
{
    ...
    public class TestsNewMethods
    {
        ...
        {
            Goods fanta = new RegularItem("fanta");
        ...
        {
            Goods pepsi = new RegularItem("pepsi");
        ...
        {
            Goods cola = new RegularItem("cola");
        ...
        {
            Goods Cola = new SpecialItem("Cola");
        ...
        {
            Goods Mirenda = new SpecialItem("Mirenda");
        ...
        {
            Goods Coffee = new SalesItem("Coffee");
        ...
        {
            Goods OrangeJus = new SalesItem("OrangeJus");
